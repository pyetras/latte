...
/********************   AProgram    ********************/
AProgram::AProgram(ListTopDef *p1)
{
  listtopdef_ = p1;
...
AnArg &AnArg::operator=(const AnArg & other)
{
  AnArg tmp(other);
  swap(tmp);
  return *this;
...
void AnArg::accept(Visitor *v)
{
  v->visitAnArg(this);
}

AnArg *AnArg::clone() const
{
  return new AnArg(*this);
}



/********************   Access    ********************/
Access::Access(Ident p1, Expr *p2)
{
  ident_ = p1;
  expr_ = p2;
...
/********************   EArrInit    ********************/
EArrInit::EArrInit(Type *p1, Expr *p2)
{
  type_ = p1;
  expr_ = p2;
...
EArrInit::EArrInit(const EArrInit & other)
{
  type_ = other.type_->clone();
  expr_ = other.expr_->clone();
...
EArrInit &EArrInit::operator=(const EArrInit & other)
{
  EArrInit tmp(other);
  swap(tmp);
  return *this;
...
void EArrInit::swap(EArrInit & other)
{
  std::swap(type_, other.type_);
  std::swap(expr_, other.expr_);
...
void EArrInit::accept(Visitor *v)
{
  v->visitEArrInit(this);
}

EArrInit *EArrInit::clone() const
{
  return new EArrInit(*this);
}
...
EGet::EGet(const EGet & other)
{
  acc_ = other.acc_->clone();

}

EGet &EGet::operator=(const EGet & other)
{
  EGet tmp(other);
  swap(tmp);
  return *this;
...
void EGet::accept(Visitor *v)
{
  v->visitEGet(this);
}

EGet *EGet::clone() const
{
  return new EGet(*this);
}
