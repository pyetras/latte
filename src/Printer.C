...
void PrintAbsyn::visitAnArg(AnArg* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitAcc(Acc*p) {} //abstract class

void PrintAbsyn::visitAccess(Access* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitEArrInit(EArrInit* p)
{
  int oldi = _i_;
  if (oldi > 5) render(_L_PAREN);
...
void PrintAbsyn::visitEGet(EGet* p)
{
  int oldi = _i_;
  if (oldi > 5) render(_L_PAREN);
...
void ShowAbsyn::visitAnArg(AnArg* p)
{
  bufAppend('(');
  bufAppend("AnArg");
  bufAppend(' ');
...
void ShowAbsyn::visitAcc(Acc* p) {} //abstract class

void ShowAbsyn::visitAccess(Access* p)
{
  bufAppend('(');
  bufAppend("Access");
  bufAppend(' ');
...
void ShowAbsyn::visitEArrInit(EArrInit* p)
{
  bufAppend('(');
  bufAppend("EArrInit");
  bufAppend(' ');
...
void ShowAbsyn::visitEGet(EGet* p)
{
  bufAppend('(');
  bufAppend("EGet");
  bufAppend(' ');
